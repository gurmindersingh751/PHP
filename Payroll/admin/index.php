    ...
    <div class="container-fluid">
      ...
      <div class="card mb-3">
        <div class="card-header">
          <i class="fa fa-table"></i> Employees List</div>
        <div class="card-body">
                  ...
                  if(count($data) != 0){
                    foreach ($data as $key => $datalist) {
                      ...
                      <tr>
                        ...
                        <td>$<?=number_format($datalist['annual_basic_pay'] , 2)?></td>
                        <td>$<?=number_format($datalist['tax'] , 2)?></td>
                        <td>$<?=number_format($datalist['monthly_salery'] , 2)?></td>
                        <td>
                          <div class="btn-group">
